...
function About() {
  return (
    <Box maxW="800px" mx="auto" p={5} className="about_container">
      ...
      <p>
        ...
        cultures lors de
        <strong> voyages</strong>, et me lancer dans des projets de{" "}
        <strong>bricolage</strong> ou de <strong>réparation</strong>. Je
      ...
      <p>
        ...
        suivre sur les
        <strong> réseaux sociaux</strong> pour découvrir mes dernières
        réalisations.
      </p>
      <br />
      <p>
